...
const { superAdminPrivateRoute } = require("./middlewares/superAdminPrivateRoute.middleware");

//import adminPrivateRoute Middleware
const { adminPrivateRoute } = require("./middlewares/adminPrivateRoute.middleware");
...
const { projectManagerPrivateRoute } = require("./middlewares/projectManagerPrivateRoute.middleware");
